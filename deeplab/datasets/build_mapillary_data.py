...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    './mapillary/mapillary_dataset/training/images_512_384',
...
tf.app.flags.DEFINE_string(
    'val_image_folder',
    './mapillary/mapillary_dataset/validation/images_512_384',
...
tf.app.flags.DEFINE_string(
    'output_dir', './mapillary/tfrecord_512_384',
...
def main(unused_argv):
    ...
    _convert_dataset('training', FLAGS.train_image_folder, FLAGS.train_image_label_folder)
    _convert_dataset('validation', FLAGS.val_image_folder, FLAGS.val_image_label_folder)
