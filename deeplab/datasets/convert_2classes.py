...
tf.app.flags.DEFINE_string(
    ...
    './mapillary/mapillary_dataset/training/labels',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    './mapillary/mapillary_dataset/validation/labels',
    'Folder containing annotations for validation')

tf.app.flags.DEFINE_string(
    'train_image_label_lane_marking_general_folder',
    './mapillary/mapillary_dataset/training/labels_lane_marking_general',
    'Folder containing annotations for trainng images')

tf.app.flags.DEFINE_string(
    'val_image_label_lane_marking_general_folder',
    './mapillary/mapillary_dataset/validation/labels_lane_marking_general',
    'Folder containing annotations for validation')
