...
OUTPUT_DIR="${MAPILLARY_ROOT}/tfrecord_512_384_lane_marking_general"
mkdir -p "${OUTPUT_DIR}"
...
python ./build_mapillary_data.py  \
  ...
  --train_image_label_folder="${MAPILLARY_ROOT}/mapillary_dataset/training/labels_512_384_lane_marking_general/" \
  --val_image_folder="${MAPILLARY_ROOT}/mapillary_dataset/validation/images_512_384/" \
  --val_image_label_folder="${MAPILLARY_ROOT}/mapillary_dataset/validation/labels_512_384_lane_marking_general/" \
